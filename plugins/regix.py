...
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup, CallbackQuery, Message, InputMediaPhoto, InputMediaVideo, InputMediaDocument, InputMediaAudio
...
# Versi lengkap fungsi forward dan copy_album sudah diupdate dengan custom caption dan support media_group

# ✅ Bagian penting saja disimpan untuk versi modifikasi yang bisa langsung dipakai
# Potongan kode dari fungsi: forward, copy_album, dan potongan loop utama
